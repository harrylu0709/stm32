...
/* USER CODE BEGIN 4 */
/* Enter callback function when timer expires */
void rtc_report_callback(TimerHandle_t xTimer)
{
  show_time_date_itm();
}
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  for(uint32_t i = 0; i < 4000; i++);
	...
	if(xQueueIsQueueFullFromISR(q_data) == pdFALSE/*TODO: check : is queue full ? */)
	{
		/*Queue is not full */
    ...
    xQueueSendFromISR(q_data, (void *)&user_data, NULL);
		...
		if(user_data == '\n'/*TODO: check, is user_data '\n'? */)
		{
			/*user_data = '\n' */
			/*TODO: make sure that last data byte of the queue is '\n' */
      // xQueueReceiveFromISR(q_data, (void *)&dummy, NULL);
      // xQueueSendFromISR(q_data, (void *)&user_data, NULL);
      xQueueOverwriteFromISR(q_data, (const void *)&user_data, NULL);
		}
	}
