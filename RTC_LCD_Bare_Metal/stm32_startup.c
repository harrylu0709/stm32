...
//2. Write a start-up code to initialize .data and .bss section in SRAM
//3. Call main()
void Reset_Handler(void)
{
	...
	uint8_t *pDst =(uint8_t*)&_sdata; //SRAM, get address, not value
	uint8_t *pSrc =(uint8_t*)&_la_data; //FLASH, get address, not value
