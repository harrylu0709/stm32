...
//		pGPIOHandle->pGPIOx->ARF[temp1] &= ~(0xF << (4*temp2));
//		pGPIOHandle->pGPIOx->ARF[temp1] |= (pGPIOHandle->GPIO_PinConfig.GPIO_PinAltFunMode << (4*temp2));
//	}
//
//}
...
//{
//	//do the configuration of NVIC registers of ARM cortex MX processor
//	if(EnorDi)
//	{
//		if(IRQNumber <= 31)
//		{
...
//{
//	//1. first lets find out the IPR(Interrupt Priority Reigsters) register
